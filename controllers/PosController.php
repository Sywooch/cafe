    ...
    public function behaviors() {
        return [
            ...
            'access' => [
                ...
                'only' => ['index', 'view', 'create', 'update', 'delete', 'products', 'supply', 'supplyprint', 'packaging'],
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'products', 'supply', 'supplyprint', 'packaging'],
                        'roles' => ['admin'],
                    ],
                ],
            ],
