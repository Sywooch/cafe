       ...
       <!-- <a class="filter-element width90" href="javascript:void(lastmonth())"><?=Yii::t('app','lastmonth')?></a> -->
        ...
        <div id="otherOptions" style="display:none;">
            ...
            <span class="filter-element width90">
                ...
                <?=Html::textInput( 'OrderSearch[customerId]', $orderSearch['customerId'], ['class'=>'form-control width100'] )?>
            </span><br/>
            */?>
            <span class="filter-element width90">
                <label><?=Yii::t('app', 'Customer Mobile')?></label>
                <?=Html::textInput( 'OrderSearch[customerMobile]', $orderSearch['customerMobile'], ['class'=>'form-control width100'] )?>
            </span><br/>
            <span class="filter-element width90">
                <label><?=Yii::t('app', 'Customer Name')?></label>
                <?=Html::textInput( 'OrderSearch[customerName]', $orderSearch['customerName'], ['class'=>'form-control width100'] )?>
            </span><br/>
            <span class="filter-element"><label>&nbsp;</label><input type="submit" class="btn btn-success" value="<?=Yii::t('app','find')?>"></span>
        </div>
    ...
    echo GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'buttons'=>[
                   'view'=>function ($url, $model, $key) {
                               return '<b>'.Html::a(' <span class="glyphicon glyphicon-eye-open"></span> ', ['report/onecustomer','customerId'=>$model['customerId']],['title'=>Yii::t('app', 'OneCustomerReport')]).'</b>';
                             },
                ]
            ...
            [
                ...
                'label' => Yii::t('app', 'Customer ID'),
            ],
            [
                'attribute' => 'customerMobile',
                'label' => Yii::t('app','Customer Mobile'),
            ],
            [
