...
$this->title = $subsystem->subsystemTitle.' - '.Yii::t('app', 'WeekdailyIncomeReport');
...
<span class="col1">
    ...
    <div><b><?=Html::a( Yii::t('app', 'WeekdailyIncomeReport'), ['/subsystem/weekdailyincomereport','subsystemId'=>$post['subsystemId']], ['class'=>'filter-element'] )?></b></div>
    ...
    <form method="get" id="filterform">
        <input type="hidden" name="r" value="subsystem/weekdailyincomereport">
